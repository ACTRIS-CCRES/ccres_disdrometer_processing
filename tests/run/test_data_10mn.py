...
#     yesterday = "/homedata/ygrit/tests_production_data/preprocessing_outputs/lindenberg/20240103_lindenberg_preprocessed_ws.nc"  # noqa E501
#     today = "/homedata/ygrit/tests_production_data/preprocessing_outputs/lindenberg/20240104_lindenberg_preprocessed_ws.nc"  # noqa E501
#     tomorrow = "/homedata/ygrit/tests_production_data/preprocessing_outputs/lindenberg/20240105_lindenberg_preprocessed_ws.nc"  # noqa E501
...
def test_bug_lindenberg():
    """Bug when partially missing weather data in Cloudnet files, fixed."""
    yesterday = "/homedata/ygrit/tests_production_data/preprocessing_outputs/lindenberg/20240224_lindenberg_preprocessed_ws.nc"  # noqa E501
    today = "/homedata/ygrit/tests_production_data/preprocessing_outputs/lindenberg/20240225_lindenberg_preprocessed_ws.nc"  # noqa E501
    tomorrow = "/homedata/ygrit/tests_production_data/preprocessing_outputs/lindenberg/20240226_lindenberg_preprocessed_ws.nc"  # noqa E501
    conf = "/home/ygrit/disdro_processing/ccres_disdrometer_processing/tests/data/conf/config_lindenberg_mira-parsivel.toml"  # noqa E501
    output = "/home/ygrit/disdro_processing/ccres_disdrometer_processing/ccres_disdrometer_processing/processing/Lindenberg_test_bug_20240225.nc"  # noqa E501
    if os.path.exists(output):
        os.remove(output)
    # Processing with weathers
    process(yesterday, today, tomorrow, conf, output, no_meteo=False, verbosity=1)
